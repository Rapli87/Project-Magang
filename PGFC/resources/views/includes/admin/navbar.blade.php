     ...
     <div class="topbar container-fluid">
         ...
         <ul class="topbar-menu d-flex align-items-center gap-3">
             ...
             <li class="dropdown">
                 <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
                     aria-haspopup="false" aria-expanded="false">
                     <img src="{{ url('backend/assets/images/flags/us.jpg') }}" alt="user-image" class="me-0 me-sm-1" height="12">
                                 ...
                                 <div class="d-flex align-items-center">
                                     <div class="flex-shrink-0">
                                         <div class="notify-icon">
                                             <img src="{{ url('backend/assets/images/users/avatar-1.jpg') }}"
                         ...
                         <a href="javascript:void(0);"
                             ...
                             <div class="card-body">
                                 <div class="d-flex align-items-center">
                                     <div class="flex-shrink-0">
                                         <div class="notify-icon">
                                             <img src="{{ url('backend/assets/images/users/avatar-5.jpg') }}"
                                                 class="img-fluid rounded-circle" alt="" />
                                         </div>
                                     </div>
                                     <div class="flex-grow-1 text-truncate ms-2">
             ...
             <li class="dropdown">
                 <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#"
                     ...
                     <span class="account-user-avatar">
                         <img src="{{ url("backend/assets/images/users/avatar-1.jpg") }}" alt="user-image" width="32"
                 ...
                 <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                     ...
                     {{-- Logout tanpa route, tapi dengan construct --}}
                     {{-- <a href="{{ route('logout') }}"
